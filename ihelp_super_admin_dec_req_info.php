      	...
      	<section id="main-content">
		  	...
		  	<div class="row">
                ...
                <form method="POST">
                   ...
                   <div>
                   <button class="btn btn-success" name="btnDecline" id="btnApprove" type="submit"> Aprove</button>
                   </div>
                </form>
              	<!-- page end-->
          	</section>
