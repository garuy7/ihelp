<?php
  ...
  if(loggedin())
  {
    ...
    if(isset($_POST['btnApprove']))
    {
      ...
      {
        echo "<script>alert('No more pending request to be approved in this page.');</script>";
      }
      else
      {
        $query0 = "UPDATE `job_request` SET `jo_status`='1', `jo_noted_by`='$user_id' WHERE `jo_trans_no` = '$lbl_transno'";
      	...
      	<section id="main-content">
		  	...
		  	<div class="row">
                ...
                <form method="POST">
                   ...
                   <label type="text" name="lbl_transno" value="<?php if(isset($_POST['lbl_transno'])){ echo htmlentities($_POST['lbl_transno']);}?>"><?php echo $row['jo_trans_no']; ?></label>
