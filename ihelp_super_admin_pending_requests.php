                            ...
                            <table class="table table-striped table-advance table-hover">
                                <tbody>
                                    ...
                                    ?>
                                                <tr>
                                                    <td>
                                                        <a href='ihelp_super_admin_pend_req_info.php?jo_trans_no=<?php echo $rows['jo_trans_no']?>&user_id=<?php echo $rows['user_id']?>'>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a class="btn btn-primary" href='ihelp_super_admin_pend_req_info.php?jo_trans_no=<?php echo $rows['jo_trans_no']?>&user_id=<?php echo $rows['user_id']?>'><i class="icon_plus_alt2"></i> view</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                    <?php
