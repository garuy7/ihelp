    ...
    <section id="container" class="">
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><i class="fa fa fa-bars"></i> Sent Requests</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <?php
                                $query = "SELECT job_request.jo_trans_no, job_request.jo_building, job_request.jo_user_id, job_request.jo_problem_type, job_request.jo_quantity, job_request.jo_status, job_request.jo_date_request, job_request.jo_noted_by, job_request.jo_status, users.user_id FROM job_request INNER JOIN users ON job_request.jo_user_id = users.user_id ORDER BY job_request.jo_date_request DESC";
                                $query_run = mysql_query($query);
                            ?>
                            <table class="table table-striped table-advance table-hover">
                                <tbody>
                                    ...
                                    ?>
                                                <tr>
                                                    <td>
                                                        <a href='ihelp_dept_sent_req_info.php?jo_trans_no=<?php echo $rows['jo_trans_no']; ?>&user_id=<?php echo $rows['user_id']; ?>&jo_status=<?php echo $rows['jo_status']; ?>'>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a class="btn btn-primary" href='ihelp_dept_sent_req_info.php?jo_trans_no=<?php echo $rows['jo_trans_no']; ?>&user_id=<?php echo $rows['user_id']; ?>&jo_status=<?php echo $rows['jo_status']; ?>'><i class="icon_plus_alt2"></i> view</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                    <?php
